...
const App = () => {
    ...
    // ) => {
    //     const newTodoState: todoInterface[] = [...todos];
    //     newTodoState.find((todo: todoInterface) => todo.id === id)!.name =
    //         e.target.value;
    //     setTodos(newTodoState);
    // };
    ...
    //     const newTodoState: todoInterface[] = todos.filter(
